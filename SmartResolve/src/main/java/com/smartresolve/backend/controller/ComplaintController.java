...
import com.smartresolve.backend.service.ComplaintService;
...
public class ComplaintController {
    ...
    public ComplaintResponse assignComplaint(
        ...
        return complaintService.assignComplaint(id, request);
    }
    ...
    public List<ComplaintResponse> getAssignedComplaints(
        ...
        return complaintService.getAssignedComplaints(email);
    }
}